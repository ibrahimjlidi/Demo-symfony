 ...
 */
final class Version20230307133247 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demo (id INT NOT NULL, name VARCHAR(255) NOT NULL, topic VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN demo.created_at IS \'(DC2Type:datetime_immutable)\'');
